...
- Any issues regarding outdated Prismarine versions will be CLOSED. Make sure you can reproduce the issue on the latest build before submitting an issue.
...
#### OS and versions
<!---
Valid version must contain build number or git hash, "latest" is invalid. Use the 'version' command in Prismarine.
If the version is invalid, the issue will be CLOSED
Game versions include Pocket Edition, Windows 10 Edition version
-->
* Prismarine:
* PHP:
* Server OS:
